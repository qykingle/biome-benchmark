...
class LazySet {
	...
	/**
	 * @param {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext} context context
	 */
	serialize({ write }) {
		if (this._needMerge) this._merge();
	...
	/**
	 * @template T
	 * @param {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext} context context
